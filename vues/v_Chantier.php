...
<p><td><input type="button" style="width:200px;height:50px" onclick="alterChant(<?php echo $i?>);" name="modifierChantier" value="modifier" alt="modifier <?php echo $nom.' '.$num?>" title="modifier <?php echo $nom.' '.$num?>"><input type="button" name="supprimer" style="width:200px;height:50px" value="supprimer" onclick="delChant(<?php echo $i ?>);"></td></p>
</tr>
<?php	
$i+=1;
}
