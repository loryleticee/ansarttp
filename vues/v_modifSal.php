...
foreach ($lesSal as $unSAl) {
	...
	<td><input type="button" style="width:150px;height:50px" name="modifier" value="modifier" alt="modifier <?php echo $nom.' '.$prenom?>" title="modifier <?php echo $nom.' '.$prenom?>" onclick="alterSalarie(<?php echo $i ?>)">
	<input type="button" style="width:150px;height:50px" name="supprimer" value="supprimer" alt="supprimer <?php echo $nom.' '.$prenom?>" title="supprimer <?php echo $nom.' '.$prenom?>" onclick="delSal(<?php echo $i ?>)"></td></p>
</tr>
<?php	
	}
$i+=1;
