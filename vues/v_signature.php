...
<?php //var_dump($_SESSION);?>
		...
		<button type="button" style="width:350px;height:50px;" onclick="v=prompt('Si vous nête pas <?php echo $_SESSION['nom'].' '.$_SESSION['prenom']?> \nSaisissez \n Votre nom et votre prenom séparés d`un espace \nEXEMPLE :<?php echo strtolower($_SESSION['nom'].' '.$_SESSION['prenom'])?>' ,'<?php echo strtolower($_SESSION['nom'].' '.$_SESSION['prenom'])?>');sureName(v);signatureSave();">
			ENREGISTRER 
		</button>
